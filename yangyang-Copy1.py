...
cyberbattlechain = cast(
    CyberBattleEnv, gym.make("CyberBattleToyCtf-v0", attacker_goal=cyberbattle_env.AttackerGoal(own_atleast_percent=args.ownership_goal, reward=args.reward_goal))
)
